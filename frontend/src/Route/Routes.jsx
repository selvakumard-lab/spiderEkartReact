...
// import Carousels from "../Components/BonusUi/Carousels";
...
export const routes = [
  ...
  { path: `master/package`, Component: <PricingMembershipContain /> },
  ...
  // { path: `email-app/read-mail`, Component: <ReadMail /> },
  // { path: `email-app/compose`, Component: <Compose /> },
  // { path: `chat-app`, Component: <ChatApp /> },
  // { path: `video-chat-app`, Component: <VideoApp /> },

  // { path: `users/user-profile`, Component: <UsersProfileContain /> },
  // { path: `users/user-edit`, Component: <UsersEditContain /> },
  // { path: `users/user-cards`, Component: <UsersCardssContain /> },
  ...
  // { path: `forms/input-group`, Component: <InputGroup /> },
  // { path: `forms/mega-options`, Component: <MegaOptionsContain /> },
  // { path: `forms/baseInput`, Component: <BaseInput /> },

  // { path: `form-layout/form-default`, Component: <FormDefault /> },

  // { path: `table/reactstrap-table`, Component: <BasicTable /> },
  ...
  // { path: `icons/feather-icons`, Component: <FeatherIcon /> },
  // { path: `icons/flag-icons`, Component: <FlagIcon /> },
  // { path: `icons/font-awsome-icon`, Component: <Fontawesome /> },
  // { path: `icons/ico-icons`, Component: <IcoIcons /> },
  // { path: `icons/themify-icons`, Component: <ThemifyIcons /> },
  // { path: `icons/weather-icons`, Component: <WeatherIcons /> },
  // { path: `buttons/default-btn`, Component: <DefaultButton /> },
  // { path: `buttons/group-btn`, Component: <GroupButton /> },
  ...
  // { path: `blog/blog-single`, Component: <BlogSingle /> },
  // { path: `blog/blog-post`, Component: <BlogPost /> },
  // { path: `job-search/job-apply`, Component: <ApplyContain /> },
  // { path: `job-search/job-detail`, Component: <JobDetails /> },
  // { path: `job-search/job-list`, Component: <ListView /> },
  // { path: `job-search/card-view`, Component: <JobCardsContain /> },
  // { path: `knowledgebase/knowledge-category`, Component: <KnowledgeCategoryContain /> },
  // { path: `knowledgebase/knowledgebase`, Component: <KnowledgeBaseContain /> },
  // { path: `knowledgebase/knowledge-detail-contain`, Component: <KnowledgeDetailContain /> },
  // { path: `editor/ck-editor`, Component: <CkEditorContain /> },
  // { path: `editor/ace-code-editor`, Component: <ACEEditorContain /> },
  // { path: `editor/mde-editor`, Component: <MdeEDitorContain /> },
  // { path: `gallery/mesonry-gallery`, Component: <MesonryGalleryContain /> },
  // { path: `gallery/mesonry-desc`, Component: <MesonryDescContain /> },
  // { path: `gallery/image-hover`, Component: <ImageHoverContain /> },
  // { path: `gallery/image-with-desc`, Component: <ImageWithDescContain /> },
  // { path: `gallery/image-gallery`, Component: <ImageGalleryContain /> },
  // { path: `sample-page`, Component: <SampleCard /> },
  // { path: `map/pigeon-map`, Component: <MapJsContain /> },
  // { path: `map/google-map`, Component: <GoolgeMapsContain /> },
  // { path: `learning/learning-detail`, Component: <DetailCourseContain /> },
  // { path: `charts/apex-charts`, Component: <ApexchartsContain /> },
  // { path: `charts/google-chart`, Component: <GoogleChartsContain /> },
  // { path: `calendar/draggable-calendar`, Component: <DraggableContain /> },
  // { path: `charts/chart-js`, Component: <ChartJsContain /> },
  ...
  // { path: `bonus-ui/tour`, Component: <Tour /> },
  // { path: `bonus-ui/sweet-alert`, Component: <SweetAlert /> },
  ...
  // { path: `bonus-ui/range-slider`, Component: <RangeSlider /> },
  // { path: `bonus-ui/image-cropper`, Component: <ImageCropper /> },
  // { path: `bonus-ui/sticky-notes`, Component: <StickyContain /> },
  // { path: `bonus-ui/drag-and-drop`, Component: <DragAndDropContain /> },
  // { path: `bonus-ui/image-upload`, Component: <UploadImageContain /> },
  // { path: `bonus-ui/basic-cards`, Component: <BasicCardContain /> },
  // { path: `bonus-ui/timeline`, Component: <TimeLineContain /> },
  ...
  // { path: "ecommerce/product", Component: <Product /> },
  // { path: "ecommerce/product-list", Component: <ProductList /> },
  // { path: "ecommerce/product-page/:id", Component: <ProductPage /> },
  // { path: "ecommerce/payment-details", Component: <PaymentDetails /> },
  // { path: "ecommerce/orderhistory", Component: <OrderHistory /> },
  // { path: "ecommerce/invoice", Component: <Invoice /> },
  // { path: "ecommerce/wishlist", Component: <WhishList /> },
